document.addEventListener("DOMContentLoaded", function() {
    ...
    const songs = [
      { title: "Kurchi Madatapetti",artist:"Thaman S", file: "song 1.mp3", image: "mp1.jpg" },
      { title: "Mawa Entaina", artist: "Thaman S", file: "song2.mp3", image: "mp2.jpg" },
      { title: "Bad Boys", artist: "Thaman S", file: "song3.mp3", image: "mp3.jpg" }
    ];
